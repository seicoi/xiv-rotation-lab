...
export type PetCorrectionProfile={
  ...
  traitOverride?:number;useNonTankAttack?:boolean;allowedActionIds?:number[];
...
// the old 100-based values. Living Shadow remains provisional.
...
export const PET_CORRECTION_PROFILES:Record<string,PetCorrectionProfile>={
  ...
  AST:{id:"earthly-star",job:"AST",nameJa:"アーサリースター",nameEn:"Earthly Star",kind:"ground-effect",numerator:80,denominator:90,applicability:"damage",traitOverride:104,allowedActionIds:[7439],sourceEra:"6.x+ post-squish"},
};
