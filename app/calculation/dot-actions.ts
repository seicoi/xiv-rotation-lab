export type DotAction={job:string;actionId:number;name:string;potency:number;duration:number;tickInterval?:number;initialTick?:boolean};
...
export const DOT_ACTIONS:DotAction[]=[
  ...
  {job:"DRK",actionId:3639,name:"ソルトアース",potency:50,duration:15,initialTick:true},
  ...
  {job:"DRG",actionId:88,name:"桜華狂咲",potency:40,duration:24},{job:"DRG",actionId:25772,name:"桜華繚乱",potency:45,duration:24},{job:"NIN",actionId:2270,name:"土遁の術",potency:80,duration:18,initialTick:true},{job:"SAM",actionId:7489,name:"彼岸花",potency:50,duration:60},
  ...
  {job:"SMN",actionId:25837,name:"スリップストリーム",potency:30,duration:15,initialTick:true},
